...
def run_hug_e5(batch_size, input_type, input_tokens):
    ...
    try:
        client_code(queries)  # Run the main function of hug-e5
    except Exception as e:
