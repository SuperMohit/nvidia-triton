...
## update these inputs based on the model tokenizer. Different encoders encode them differently, 
## large variation is seen in token lengths between e5-large and e5-multilingual
passages_300 = [
